...
exports.buscarPrevisaoPorCidadeEData = buscarPrevisaoPorCidadeEData;
const axios_1 = __importDefault(require("axios"));
const getCoordenadasService_1 = require("./getCoordenadasService");
...
async function buscarPrevisaoPorCidadeEData({ cidade, data, }) {
    const { latitude, longitude } = await (0, getCoordenadasService_1.buscarCoordenadas)(cidade);
...
//# sourceMappingURL=climaService.js.map